...
export const ja = {
  ...
  fabrics: {
    ...
    fromLibraryMulti: 'カメラロールから複数選択',
    bulkRegisterTitle: 'まとめて登録',
    bulkRegisterMessage: '{{count}} 枚の布地を共通のプレフィックスと連番で登録します。キャリブレーションは未設定として登録されるので、後から個別に再実行してください。',
    bulkPrefixPlaceholder: 'プレフィックス（例: 木綿）',
    bulkRegisterSuccess: '{{count}} 枚の布地を登録しました。',
    bulkRegisterFailed: '一括登録に失敗しました。',
    bulkLimitWarning: '一度に選択できるのは {{limit}} 枚までです。先頭 {{limit}} 枚のみ登録します。',
  },
  exportScreen: {
    title: 'エクスポート',
    image: '画像として保存',
