...
export const en: Translations = {
  ...
  editor: {
    ...
    unsavedMessage: 'You have unsaved edits. What would you like to do?',
  ...
  fabrics: {
    ...
    fromLibraryMulti: 'Pick multiple from library',
    bulkRegisterTitle: 'Bulk register',
    bulkRegisterMessage: 'Register {{count}} fabrics with a shared prefix and numeric suffix. Calibration is left unset; you can run it later for each fabric individually.',
    bulkPrefixPlaceholder: 'Prefix (e.g. cotton)',
    bulkRegisterSuccess: 'Registered {{count}} fabrics.',
    bulkRegisterFailed: 'Bulk registration failed.',
    bulkLimitWarning: 'You can pick up to {{limit}} images at a time. Only the first {{limit}} will be registered.',
  },
  exportScreen: {
    title: 'Export',
    image: 'Save as image',
