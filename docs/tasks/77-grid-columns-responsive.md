...
- [x] パターン選択(`DesignSelectScreen`): phone 2 列 → tablet 4 列
- [x] ホームの保存済み作品一覧: phone 1 カラム → tablet 2 カラム(SectionList/FlatList の `numColumns` 切替)
- [x] 布地一覧(`FabricsScreen`): phone 1 カラム → tablet 2 カラム
- [x] アイテムサイズ(サムネイル等)も画面幅に応じて拡大
- [x] 既存テストグリーン
