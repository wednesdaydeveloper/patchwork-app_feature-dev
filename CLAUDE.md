...
```json
{
  ...
  "design": {
    ...
    "polygons": [
      { "id": "p00", "label": "topLeft",     "path": "M 0.000 0.000 L 0.333 0.000 L 0.333 0.333 L 0.000 0.333 Z" },
      { "id": "p10", "label": "topCenter",   "path": "M 0.333 0.000 L 0.667 0.000 L 0.667 0.333 L 0.333 0.333 Z" },
      { "id": "p20", "label": "topRight",    "path": "M 0.667 0.000 L 1.000 0.000 L 1.000 0.333 L 0.667 0.333 Z" },
      { "id": "p01", "label": "middleLeft",  "path": "M 0.000 0.333 L 0.333 0.333 L 0.333 0.667 L 0.000 0.667 Z" },
      { "id": "p11", "label": "center",      "path": "M 0.333 0.333 L 0.667 0.333 L 0.667 0.667 L 0.333 0.667 Z" },
      { "id": "p21", "label": "middleRight", "path": "M 0.667 0.333 L 1.000 0.333 L 1.000 0.667 L 0.667 0.667 Z" },
      { "id": "p02", "label": "bottomLeft",  "path": "M 0.000 0.667 L 0.333 0.667 L 0.333 1.000 L 0.000 1.000 Z" },
      { "id": "p12", "label": "bottomCenter","path": "M 0.333 0.667 L 0.667 0.667 L 0.667 1.000 L 0.333 1.000 Z" },
      { "id": "p22", "label": "bottomRight", "path": "M 0.667 0.667 L 1.000 0.667 L 1.000 1.000 L 0.667 1.000 Z" }
    ]
  }
}
```
...
```json
{
  ...
  "design": {
    ...
    "polygons": [
      { "id": "center",    "label": "center",         "path": "M 0.25 0.25 L 0.75 0.25 L 0.75 0.75 L 0.25 0.75 Z" },
      { "id": "top",       "label": "topTriangle",    "path": "M 0.25 0.00 L 0.75 0.00 L 0.50 0.25 Z" },
      { "id": "bottom",    "label": "bottomTriangle", "path": "M 0.25 1.00 L 0.50 0.75 L 0.75 1.00 Z" },
