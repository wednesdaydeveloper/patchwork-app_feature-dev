...
└── scale: Float         // 表示倍率（1.0 = 画像をピースにフィットさせた初期状態。初期値は 1.0）
```
...
```json
{
  ...
  "design": {
    ...
    "polygons": [
      { "id": "p00", "label": "左上", "path": "M 0.000 0.000 L 0.333 0.000 L 0.333 0.333 L 0.000 0.333 Z" },
      { "id": "p10", "label": "中上", "path": "M 0.333 0.000 L 0.667 0.000 L 0.667 0.333 L 0.333 0.333 Z" },
      { "id": "p20", "label": "右上", "path": "M 0.667 0.000 L 1.000 0.000 L 1.000 0.333 L 0.667 0.333 Z" },
      { "id": "p01", "label": "左中", "path": "M 0.000 0.333 L 0.333 0.333 L 0.333 0.667 L 0.000 0.667 Z" },
      { "id": "p11", "label": "中央", "path": "M 0.333 0.333 L 0.667 0.333 L 0.667 0.667 L 0.333 0.667 Z" },
      { "id": "p21", "label": "右中", "path": "M 0.667 0.333 L 1.000 0.333 L 1.000 0.667 L 0.667 0.667 Z" },
      { "id": "p02", "label": "左下", "path": "M 0.000 0.667 L 0.333 0.667 L 0.333 1.000 L 0.000 1.000 Z" },
      { "id": "p12", "label": "中下", "path": "M 0.333 0.667 L 0.667 0.667 L 0.667 1.000 L 0.333 1.000 Z" },
      { "id": "p22", "label": "右下", "path": "M 0.667 0.667 L 1.000 0.667 L 1.000 1.000 L 0.667 1.000 Z" }
    ]
  }
}
```
...
```json
{
  ...
  "design": {
    ...
    "polygons": [
      { "id": "center",    "label": "中央",   "path": "M 0.25 0.25 L 0.75 0.25 L 0.75 0.75 L 0.25 0.75 Z" },
      { "id": "top",       "label": "上三角", "path": "M 0.25 0.00 L 0.75 0.00 L 0.50 0.25 Z" },
      { "id": "bottom",    "label": "下三角", "path": "M 0.25 1.00 L 0.50 0.75 L 0.75 1.00 Z" },
      { "id": "left",      "label": "左三角", "path": "M 0.00 0.25 L 0.25 0.50 L 0.00 0.75 Z" },
      { "id": "right",     "label": "右三角", "path": "M 1.00 0.25 L 0.75 0.50 L 1.00 0.75 Z" },
      { "id": "corner-tl", "label": "左上角", "path": "M 0.00 0.00 L 0.25 0.00 L 0.00 0.25 Z" },
      { "id": "corner-tr", "label": "右上角", "path": "M 0.75 0.00 L 1.00 0.00 L 1.00 0.25 Z" },
      { "id": "corner-bl", "label": "左下角", "path": "M 0.00 0.75 L 0.25 1.00 L 0.00 1.00 Z" },
      { "id": "corner-br", "label": "右下角", "path": "M 0.75 1.00 L 1.00 0.75 L 1.00 1.00 Z" }
    ]
  }
}
```
